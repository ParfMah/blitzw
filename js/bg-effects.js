...
(function () {
  ...
  var MEDIA = {
    ...
    offersGallery: [
      { src: 'https://res.cloudinary.com/duramdsjz/image/upload/f_auto,q_auto/v1784145824/privatkredit-blitz-leihen.webp',   alt: 'Privatkredit für persönliche Projekte',      eyebrow: 'Privatkredit',        title: 'Für Ihre persönlichen Projekte', desc: 'Client heureux, projet personnel (voyage, achat) — 1600×900px' },
      { src: 'https://res.cloudinary.com/duramdsjz/image/upload/f_auto,q_auto/v1784145821/immobilienfinanzierung-traumhaus.webp',     alt: 'Immobilienfinanzierung für das Eigenheim',   eyebrow: 'Immobilienfinanzierung', title: 'Ihr Traumhaus wird Realität', desc: 'Maison individuelle moderne — 1600×900px' },
      { src: 'https://res.cloudinary.com/duramdsjz/image/upload/f_auto,q_auto/v1784145820/autokredit-neuwagen-finanzierung.webp',     alt: 'Autofinanzierung für den Neuwagenkauf',      eyebrow: 'Autofinanzierung',    title: 'Ihr neues Auto, sofort verfügbar', desc: 'Véhicule neuf, concession moderne — 1600×900px' },
      { src: 'https://res.cloudinary.com/duramdsjz/image/upload/f_auto,q_auto/v1784145825/renovierungskredit-modernisierung-kueche.webp',    alt: 'Renovierungskredit für die Modernisierung',  eyebrow: 'Renovierungskredit',  title: 'Investieren Sie in Ihr Zuhause', desc: 'Rénovation intérieure moderne, artisan au travail — 1600×900px' },
      { src: 'https://res.cloudinary.com/duramdsjz/image/upload/f_auto,q_auto/v1784145820/hypothekenkredit-immobiliensicherheit.webp',       alt: 'Hypothekenkredit mit Immobiliensicherheit',  eyebrow: 'Hypothekenkredit',    title: 'Großzügiger Kapitalspielraum', desc: 'Grande propriété, ambiance patrimoniale — 1600×900px' },
      { src: 'https://res.cloudinary.com/duramdsjz/image/upload/f_auto,q_auto/v1784145825/umschuldung-kredit-zusammenfassen.webp',    alt: 'Umschuldung mehrerer bestehender Kredite',   eyebrow: 'Umschuldung',        title: 'Eine einzige, günstigere Rate', desc: 'Personne sereine consultant ses finances — 1600×900px' }
    ]
